        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductsCategoryIds = table.Column<string>(nullable: true),
                    Status = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "CategoryTranslationConfigurations",
                columns: table => new
                {
                    ID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryTranslationConfigurations", x => x.ID);
                    table.ForeignKey(
                        name: "FK_CategoryTranslationConfigurations_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CategoryTranslationConfigurations_Languages_LanguageId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { "HomeDescription", "This description is  of eShopSolution" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2021, 3, 16, 22, 49, 8, 229, DateTimeKind.Local).AddTicks(3236), 100000m, 200000m, 0 });

            migrationBuilder.InsertData(
                table: "CategoryTranslationConfigurations",
                columns: new[] { "ID", "CategoryId", "LanguageId", "Name", "SeoAlias", "SeoDescription", "SeoTitle" },
                values: new object[,]
                {
                    { 1, 1, "vi-VN", "AoNam", "ao-nam", "San Pham ao Thoi Trang nam", "SanPhamAoThoiTrangNam" },
                    { 3, 2, "vi-VN", "AoNu", "ao-nu", "San Pham ao Thoi Trang nam", "SanPhamAoThoiTrangNu" },
                    { 2, 1, "en-US", "T-Shirt Men", "T-Shirt", "Products T-shirt Men", "TshirtMen" },
                    { 4, 2, "en-US", "Women T-Shirt ", "Women T-Shirt ", "Products T-shirt Women", "Tshirt for Women" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, "Mo ta San Pham", "vi-VN", "AoNam", 1, "ao-nam", "San Pham ao Thoi Trang nam", "SanPhamAoThoiTrangNam" },
                    { 2, "", "Description of product", "en-US", "Gucci T-Shirt", 1, "T-Shirt", "Products T-shirt Men", "TshirtMen" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoryTranslationConfigurations_CategoryId",
                table: "CategoryTranslationConfigurations",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_CategoryTranslationConfigurations_LanguageId",
                table: "CategoryTranslationConfigurations",
                column: "LanguageId");
